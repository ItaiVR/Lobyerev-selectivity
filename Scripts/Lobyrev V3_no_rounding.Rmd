...
```{r}
Catch.data.Cod <- read.csv("~/kinneret modeling/selectivity/R code Feodor paper/Data/Catch data Cod.csv")
...
```{r}
net.properties <- read.csv("~/kinneret modeling/selectivity/R code Feodor paper/Data/net properties.csv")
#Show table:
...
!!!!I just import the data from your Excel, but do not know how the calculation was made
```{r}
PWE <- read.csv("~/kinneret modeling/selectivity/R code Feodor paper/Data/PWE.csv", stringsAsFactors=FALSE)
...
```{r}
G_max_wide <- read.csv("~/kinneret modeling/selectivity/R code Feodor paper/Data/G_max_wide.csv", stringsAsFactors=FALSE)
